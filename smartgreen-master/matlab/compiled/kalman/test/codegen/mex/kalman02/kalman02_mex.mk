...
MAKEFILE = kalman02_mex.mk

include kalman02_mex.mki


SRC_FILES =  \
	kalman02_data.c \
	kalman02_initialize.c \
	kalman02_terminate.c \
	kalman02.c \
	warning.c \
...
MEX_FILE_NAME_WO_EXT = kalman02_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/kalman02"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/kalman02/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/kalman02/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/kalman02/%.cu
	$(CC) $(CCFLAGS) "$<"
