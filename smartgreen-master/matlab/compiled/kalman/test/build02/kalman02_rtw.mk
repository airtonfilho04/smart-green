###########################################################################
## Makefile generated for MATLAB file/project 'kalman02'. 
## 
## Makefile     : kalman02_rtw.mk
## Generated on : Wed Apr 19 11:12:20 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/kalman02.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/andreibosco/Devel/git/smartgreen/matlab/compiled/kalman/test
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/kalman02.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/build02 -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=kalman02 -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/build02/kalman02_initialize.c $(START_DIR)/build02/kalman02_terminate.c $(START_DIR)/build02/kalman02.c $(START_DIR)/build02/rt_nonfinite.c $(START_DIR)/build02/rtGetNaN.c $(START_DIR)/build02/rtGetInf.c
...
OBJS = kalman02_initialize.o kalman02_terminate.o kalman02.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/build02/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/build02/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
