function trainParamsEnsemble = m5pparamsensemble2(varargin)
% m5pparamsensemble2
...
% This function is an alternative to function m5pparamsensemble for
% supplying parameters as name/value pairs.
%
% Call:
...
%                   the names, see description of function m5pparamsensemble.
%
% Output:
...
trainParamsEnsemble = m5pparamsensemble();
paramNames = fieldnames(trainParamsEnsemble);
...
for pair = reshape(varargin, 2, [])
    ...
    if any(found)
        trainParamsEnsemble.(paramNames{found}) = pair{2};
    else
