...
char xivelyKey[] = "jfwmk4RPmKZhsKnjPuql2wFys66bbozbV7ygIz8XhS0Yg9hU";
//your xively feed ID
#define xivelyFeed 979455761
//datastreams
char biasID[] = "RESISTANCE_BIAS";
char sensorID[] = "SENSOR";
// Define the strings for our datastream IDs
XivelyDatastream datastreams[] = {
  XivelyDatastream(biasID, strlen(biasID), DATASTREAM_FLOAT),
...
void setup() {
  ...
  if (!SD.begin(chipSelect)) {
    Serial.println("SD falhou ou nao esta presente");
...
//    dataString += "sensor bias compensated value =";
    ...
    // TEMP: xively
    //////////////////
    datastreams[0].setFloat(bias);
    datastreams[1].setFloat(sensor1);

    Serial.println("Uploading");
    int ret = xivelyclient.put(feed, xivelyKey);
    //return message
    Serial.print("xively returned ");
    Serial.println(ret);
    Serial.println("");
    ///////////////////
